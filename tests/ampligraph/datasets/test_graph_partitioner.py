...
def test_abstract_graph_partitioner_get_triples():
...
def test_random_edges_graph_partitioner():
    template_test_edges_graph_partitioner(RandomEdgesGraphPartitioner)


def test_random_vertices_graph_partitioner():
    X = get_test_graph()
