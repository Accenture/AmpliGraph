...
class Optimizer(abc.ABC):
    ...
    def __init__(self, optimizer_params, verbose):
    ...
    def apply_gradients(self, grads_and_vars):
        ...
        Parameters
        ----------
        grads_and_vars: zipped object
            Zipped object of gradients and trainable variables
...
class AdagradOptimizer(Optimizer):
    ...
    def __init__(self, optimizer_params={}, verbose=False):
        """Initialize the Optimizer
        ...
        super(AdagradOptimizer, self).__init__(optimizer_params, verbose)
...
class AdamOptimizer(Optimizer):
    ...
    def __init__(self, optimizer_params={}, verbose=False):
        ...
        super(AdamOptimizer, self).__init__(optimizer_params, verbose)
...
class SGDOptimizer(Optimizer):
    ...
    def __init__(self, optimizer_params={}, verbose=False):
        ...
        verbose : bool
            Enable/disable verbose mode
        """
        super(SGDOptimizer, self).__init__(optimizer_params, verbose)
...
def get(identifier):
    if isinstance(identifier, Optimizer):
        ...
        return OPTIMIZER_REGISTRY.get(identifier)()
    else:
